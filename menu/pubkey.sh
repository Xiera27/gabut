...
clear
	...
	chmod +x *
	mv * /etc/slowdns
	wget -O /etc/systemd/system/client.service "https://raw.githubusercontent.com/nilaa27/sayang/main/wireguard/client" >/dev/null 2>&1
	wget -O /etc/systemd/system/server.service "https://raw.githubusercontent.com/nilaa27/sayang/main/wireguard/server" >/dev/null 2>&1
